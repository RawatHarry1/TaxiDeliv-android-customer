...
import com.ujeff_customer.databinding.DialogAddAddressBinding
import com.ujeff_customer.databinding.FragmentSelectLocationBinding
import com.ujeff_customer.model.api.Status
...
import com.ujeff_customer.util.convertDouble
import com.ujeff_customer.util.showSnackBar
import com.ujeff_customer.util.textChanges
import com.ujeff_customer.view.activity.walk_though.ui.home.PickDropAdapter
...
//                    viewModel.searchPlaces(it.toString())
    ...
    private fun observeSearchPlaces() = viewModel.searchLocationData.observe(viewLifecycleOwner) {
        when (it.status) {
            ...
            com.ujeff_customer.model.api.Status.LOADING -> {
            ...
            com.ujeff_customer.model.api.Status.SUCCESS -> {
            ...
            com.ujeff_customer.model.api.Status.ERROR -> {
                requireActivity().runOnUiThread {
                    if (args.selectLocationType == "add_address")
                        binding.addAddressProgress.isVisible = false
                    else
