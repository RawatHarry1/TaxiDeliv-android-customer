package com.ujeff_customer.view.fragment.cancelRideFragment
...
import com.ujeff_customer.databinding.FragmentCancelRideBinding
...
import com.ujeff_customer.view.adapter.CancelRideAdapter
...
class CancelRideFragment : BaseFragment<FragmentCancelRideBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (it.containsKey("referenceId")) {
                rideVM.createRideData.referenceId = it.getString("referenceId").orEmpty()
            }
    ...
    private fun setClicks() {
        ...
        binding.btnCancel.setOnSingleClickListener {
            if (CancelRideAdapter.selectedText.isNullOrEmpty() && binding.etReason.text?.trim()
                    .isNullOrEmpty()
            ) {
            ...
            DialogUtils.getNegativeDialog(
                ...
                rideVM.cancelTrip(
                    ...
                    rideVM.createRideData.referenceId.orEmpty(),
