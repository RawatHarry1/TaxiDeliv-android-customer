package com.ujeff_customer.viewmodel.rideVM
...
class RideVM @Inject constructor(
    ...
    var isPaymentInitialized = false
    var promoCode = ""
    var cardId = ""
    var last4 = ""
    var schedule = false
    ...
    fun requestRideData(
        ...
        rideRepo.requestTrip(
            jsonObject = JSONObject().apply {
                ...
                put("estimated_fare", (createRideData.vehicleData?.original_fare ?: 0.0).toString())
...
//                    put("customerNote", notes)
                ...
                if (paymentOption == 9) {
                    ...
                    put("preferred_payment_mode", "40")
                    put("paystack_reference_id", payStackReferenceId)
                }
    ...
    fun scheduleRideData(
        ...
        rideRepo.requestSchedule(
            jsonObject = JSONObject().apply {
                ...
                put("fare", (createRideData.vehicleData?.original_fare ?: 0.0).toString())
    ...
    fun cancelTrip(sessionId: String, reason: String, referenceId: String, currency: String) {
        viewModelScope.launch {
            rideRepo.cancelTrip(sessionId = sessionId, jsonObject = JSONObject().apply {
                put("sessionId", sessionId)
                put("reasons", reason)
                put("paystack_reference_id", referenceId)
