...
import com.superapp_customer.databinding.DialogAddAddressBinding
import com.superapp_customer.databinding.FragmentSelectLocationBinding
import com.superapp_customer.model.api.Status
...
import com.superapp_customer.util.textChanges
import com.superapp_customer.view.activity.walk_though.ui.home.PickDropAdapter
...
//                    viewModel.searchPlaces(it.toString())
    ...
    private fun observeSearchPlaces() = viewModel.searchLocationData.observe(viewLifecycleOwner) {
        when (it.status) {
            ...
            com.superapp_customer.model.api.Status.LOADING -> {
            ...
            com.superapp_customer.model.api.Status.SUCCESS -> {
            ...
            com.superapp_customer.model.api.Status.ERROR -> {
                requireActivity().runOnUiThread {
                    if (args.selectLocationType == "add_address")
                        binding.addAddressProgress.isVisible = false
                    else
