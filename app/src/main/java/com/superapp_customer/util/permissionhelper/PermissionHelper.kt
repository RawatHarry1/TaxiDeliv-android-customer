package com.superapp_customer.util.permissionhelper
...
import com.superapp_customer.listeners.permissionhelper.IGetPermissionListener
...
class PermissionHelper {
    ...
    fun setPermissionResult(permissionMap: MutableMap<String, Boolean>) {
        ...
        when (isAllPermissionGranted) {
            ...
            PERMISION_RATIONAL -> {
                showDialog(
                    VenusApp.appContext.resources?.getString(R.string.permission_from_device)!!,
                )
            }
        }
    }
                ...
                if (fragment != null) {
                    fragment!!.startActivity(
                        Intent(
                            ...
                            Uri.parse("package:" +  VenusApp.appContext.packageName)
                        )
                    )
                } else {
