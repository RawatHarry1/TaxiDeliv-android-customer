...
import com.mb_driver.databinding.ActivityVehicleInfoBinding
import com.mb_driver.databinding.ItemAppTypesBinding
import com.mb_driver.model.api.observeData
import com.mb_driver.model.dataclassses.clientConfig.ClientConfigDC
import com.mb_driver.model.dataclassses.clientConfig.OperatorAvailablity
import com.mb_driver.model.dataclassses.userData.UserDataDC
import com.mb_driver.util.SharedPreferencesManager
import com.mb_driver.util.arrayAdapter
import com.mb_driver.util.fetchYearsList
import com.mb_driver.util.getValue
import com.mb_driver.util.vehicleModelAdapter
