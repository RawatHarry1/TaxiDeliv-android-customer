...
import com.mb_driver.databinding.ActivityCreateProfileBinding
import com.mb_driver.dialogs.DialogUtils
import com.mb_driver.model.api.getJsonRequestBody
...
import com.mb_driver.util.NoSpaceInputFilter
import com.mb_driver.util.SharedPreferencesManager
import com.mb_driver.util.ValidationUtils
import com.mb_driver.util.getValue
...
class CreateProfile : BaseActivity<ActivityCreateProfileBinding>() {
    ...
    private fun checkValidation(): Boolean {
        return when {
            ...
            binding.etStreet.getValue().trim().isEmpty() -> {
                showErrorMessage(getString(R.string.please_enter_street_name))
                false
            }
