...
import com.marsapp_driver.databinding.ActivityWalkthorughBinding
import com.marsapp_driver.util.SharedPreferencesManager
import com.marsapp_driver.viewmodel.WalkThroughViewModel
...
//        if (BuildConfig.APPLICATION_ID == VENUS_PACKAGE_NAME) {
            ...
            listData.add(
                WalkData(
                    ...
                    getString(R.string.empty_string),
                    ContextCompat.getDrawable(this, R.drawable.mars_intro_1)
                )
            )
            listData.add(
                WalkData(
                    getString(R.string.empty_string),
                    getString(R.string.empty_string),
                    ContextCompat.getDrawable(this, R.drawable.mars_intro_2)
                )
            )
            listData.add(
                WalkData(
                    getString(R.string.empty_string),
                    getString(R.string.empty_string),
                    ContextCompat.getDrawable(this, R.drawable.mars_intro_3)
                )
            )
//        } else {
