package com.marsapp_driver.view.ui.home_drawer
...
import com.marsapp_driver.databinding.ActivityHomeBinding
...
import com.marsapp_driver.util.commonToast
import com.marsapp_driver.util.deleteAlert
import com.marsapp_driver.util.logoutAlert
import com.marsapp_driver.view.base.BaseActivity
import com.marsapp_driver.view.ui.PaymentActivity
import com.marsapp_driver.view.ui.SignUpInActivity
...
//        getLocationResult()
    ...
    private fun observeLogout() = userVM.logout.observeData(this, onLoading = {
        ...
        SharedPreferencesManager.clearKeyData(SharedPreferencesManager.Keys.PASSCODE)
