package com.salonedriver.customClasses.singleClick

import android.os.SystemClock
import android.view.View
import com.salonedriver.customClasses.singleClick.SingleClick
...
class SingleClickListenerHandler(
    ...
    override fun onClick(view: View?) {
        if ((SystemClock.elapsedRealtime() - lastClickTime) < TimeUnit.SECONDS.toMillis(2)) {
            return
        }
