...
class RideViewModel @Inject constructor(
    ...
    fun endTrip(customerId: String, tripId: String, dropLatitude: String, dropLongitude: String, distanceTravelled: String, rideTime: String, waitTime: String) = viewModelScope.launch {
        rideRepo.endTrip(customerId, tripId, dropLatitude, dropLongitude, distanceTravelled, rideTime, waitTime).setApiState(_endTrip)
    }
