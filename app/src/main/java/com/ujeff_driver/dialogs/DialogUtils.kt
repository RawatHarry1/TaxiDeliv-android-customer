package com.ujeff_driver.dialogs
...
import com.ujeff_driver.databinding.DialogEditProfilePictureBinding
...
object DialogUtils {
    ...
    fun getNegativeDialog(
        ...
        title: String,
        cancelTxt:String? = "",
        onClickNegativeResult: (Int) -> Unit?): Dialog {
