...
import com.ujeff_driver.databinding.FragmentAcceptTripBinding
...
import com.ujeff_driver.firebaseSetup.PackageDetails
...
import com.ujeff_driver.view.ui.home.cancelTrip.CancelTrip
        ...
        binding.tvCancel.setOnClickListener {
            cancelTrip {
                Intent(this, CancelTrip::class.java).apply {
                    ...
                    putExtra("paystackReference", rideData?.paystackReference.orEmpty())
                    startActivity(this)
                }
            }
        }
