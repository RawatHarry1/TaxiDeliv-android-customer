...
import com.ujeff_driver.databinding.CancelRideBinding
...
class CancelTrip: BaseActivity<CancelRideBinding>() {
    ...
    private val payStackReference by lazy { intent.getStringExtra("paystackReference").orEmpty() }
        ...
        binding.tvCancelRide.setOnClickListener {
            ...
            if (reason.isEmpty()){
                ...
                viewModel.cancelTrip(jsonObject = JSONObject().apply {
                    ...
                    put("paystack_reference_id",payStackReference)
