package com.ujeff_driver.view.ui.home_drawer.ui.home
...
import com.ujeff_driver.customClasses.LocationResultHandler
import com.ujeff_driver.customClasses.SingleFusedLocation
import com.ujeff_driver.customClasses.singleClick.setOnSingleClickListener
import com.ujeff_driver.databinding.DialogTripsBinding
import com.ujeff_driver.databinding.FragmentHomeBinding
...
import com.ujeff_driver.firebaseSetup.SoundService
import com.ujeff_driver.model.api.observeData
import com.ujeff_driver.model.dataclassses.userData.UserDataDC
import com.ujeff_driver.socketSetup.SocketSetup
import com.ujeff_driver.socketSetup.locationServices.LocationService
import com.ujeff_driver.trackingData.StepInstruction
import com.ujeff_driver.trackingData.animateDriver
import com.ujeff_driver.trackingData.clearMap
import com.ujeff_driver.trackingData.findEta
import com.ujeff_driver.trackingData.showPath
import com.ujeff_driver.trackingData.vectorToBitmap
import com.ujeff_driver.util.AppUtils
import com.ujeff_driver.util.DriverDocumentStatusForApp
import com.ujeff_driver.util.SharedPreferencesManager
import com.ujeff_driver.util.TripStatus
import com.ujeff_driver.util.documentNotVerifiedBottomSheet
import com.ujeff_driver.util.formatAmount
import com.ujeff_driver.view.base.BaseFragment
import com.ujeff_driver.view.ui.CancelTripActivity
import com.ujeff_driver.view.ui.chat.ChatActivity
import com.ujeff_driver.view.ui.home.AcceptTripActivity
import com.ujeff_driver.view.ui.home.PackageListActivity
...
//                tvSlideTrip.backgroundTintList = context.getColorStateList(R.color.theme_button)
                ...
                tvBestRoute.text = getString(R.string.txt_best_route)
...
//                    }
    ...
    override fun cancelledByAdmin() {
        super.cancelledByAdmin()
        requireActivity().runOnUiThread {
            try {
                Log.i("PUSHNOTI", "IN cancelledByAdmin")
                rideViewModel.ongoingTrip()
            } catch (e: Exception) {
                Log.i("PUSHNOTI", "IN cancelledByAdmin:: ${e.message}")
                e.printStackTrace()
            }
        }
    }
