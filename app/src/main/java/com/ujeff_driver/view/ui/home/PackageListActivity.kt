...
import com.ujeff_driver.databinding.ActivityPackageListBinding
import com.ujeff_driver.databinding.ItemPackageImagesBinding
import com.ujeff_driver.databinding.ItemPackageListBinding
import com.ujeff_driver.databinding.ItemUploadPackageImageBinding
...
import com.ujeff_driver.model.dataclassses.rideModels.OngoingPackages
                ...
                if (isReject) {
                    ...
                    if (rejectionReason.isNotEmpty()) {
                        ...
                        viewModel.updatePackage(
                            ...
                            packageId,
                            rejectionReason,
                            packImageArrayList.filter { it.isNotEmpty() },
                            isEndTrip
                        )
                    } else
    ...
    private fun observeUpdatePackageStatus() =
        viewModel.updatePackage.observeData(this, onLoading = {
            ...
            if (isEndTrip) {
                ...
                if (this?.deliveryRestriction != null) {
                    DialogUtils.showCanNotDeliver(
                        this@PackageListActivity, 0, this.deliveryRestriction, "Dismiss"
                    ) {}
                }
            } else {
                if (this?.can_start != 1) {
